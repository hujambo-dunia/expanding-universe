## Trending Bioinformatics Repositories (Updated: 2026-09-24)

**Showing 73 projects matching the criteria (250+ stars, recent updates)**

- **[K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills)** – ⭐ 46342 – Turn any AI agent into an AI Scientist. The #1 Agent Skills library for science, used by 190,000+ scientists worldwide. 165 ready-to-use validated skills plus 100+ scientific databases covering biology, chemistry, medicine, and drug discovery. Compatible with Cursor, Claude Code, Codex, Pi, Antigravity, and the open Agent Skills standard.
...
- **[duerrsimon/bioicons](https://github.com/duerrsimon/bioicons)** – ⭐ 1743 – A library of free open source icons for science illustrations in biology and chemistry
...
- **[thetahealth/mirobody](https://github.com/thetahealth/mirobody)** – ⭐ 1338 – The AI-native health data engine — collect, translate, and reason with AI Agents over labs results, wearables & genomics.
...
- **[proxysoul/Empryo](https://github.com/proxysoul/Empryo)** – ⭐ 1275 – Empryo's engine, v2 (soulforge) and issue tracker!! Empryo is the graph-powered AI coding agent that edits symbols, not strings: AST surgery, full LSP, a live code genome. Get it at https://empryo.com
- **[scikit-bio/scikit-bio](https://github.com/scikit-bio/scikit-bio)** – ⭐ 1244 – scikit-bio: a community-driven Python library for bioinformatics, providing versatile data structures, algorithms and educational resources.
- **[scverse/gget](https://github.com/scverse/gget)** – ⭐ 1200 – 🧬 gget enables efficient querying of genomic reference databases
- **[xuzhougeng/wisp-science](https://github.com/xuzhougeng/wisp-science)** – ⭐ 1166 – Open-source, local-first desktop AI research workbench for scientific computing with Python/R, MCP bioinformatics tools, SSH/WSL/GPU runtimes, and OpenAI/Anthropic models.
...
- **[CosmosMind-ai/RSI-Harness](https://github.com/CosmosMind-ai/RSI-Harness)** – ⭐ 721 – RSIH — versionable, shareable agent harness: Pi coding agent + Genome config layer
...
- **[openbiox/awosome-bioinformatics](https://github.com/openbiox/awosome-bioinformatics)** – ⭐ 522 – A curated list of resources for learning bioinformatics.
...
- **[songlab-cal/gpn](https://github.com/songlab-cal/gpn)** – ⭐ 380 – Genomic Pretrained Network - GPN, GPN-MSA, PhyloGPN, GPN-Star
...
- **[tjiangHIT/cuteSV](https://github.com/tjiangHIT/cuteSV)** – ⭐ 294 – Long read based human genomic structural variation detection with cuteSV
