## Trending Bioinformatics Repositories (Updated: 2025-09-25)

**Showing 60 projects matching the criteria (250+ stars, recent updates)**

- **[deepchem/deepchem](https://github.com/deepchem/deepchem)** – ⭐ 6225 – Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry, Materials Science and Biology
- **[ArcInstitute/evo2](https://github.com/ArcInstitute/evo2)** – ⭐ 3097 – Genome modeling and design across all domains of life
- **[satijalab/seurat](https://github.com/satijalab/seurat)** – ⭐ 2524 – R toolkit for single cell genomics
- **[lh3/minimap2](https://github.com/lh3/minimap2)** – ⭐ 2037 – A versatile pairwise aligner for genomic and spliced nucleotide sequences
...
- **[materialsproject/pymatgen](https://github.com/materialsproject/pymatgen)** – ⭐ 1724 – Python Materials Genomics (pymatgen) is a robust materials analysis code that defines classes for structures and molecules with support for many electronic structure codes. It powers the Materials Project.
- **[duerrsimon/bioicons](https://github.com/duerrsimon/bioicons)** – ⭐ 1532 – A library of free open source icons for science illustrations in biology and chemistry
...
- **[oschwengers/bakta](https://github.com/oschwengers/bakta)** – ⭐ 551 – Rapid & standardized annotation of bacterial genomes, MAGs & plasmids
...
- **[moshi4/pyGenomeViz](https://github.com/moshi4/pyGenomeViz)** – ⭐ 362 – A genome visualization python package for comparative genomics
...
- **[songlab-cal/gpn](https://github.com/songlab-cal/gpn)** – ⭐ 288 – Genomic Pre-trained Network
