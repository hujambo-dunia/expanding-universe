...
- **[ArcInstitute/evo2](https://github.com/ArcInstitute/evo2)** – ⭐ 2987 – Genome modeling and design across all domains of life
...
- **[materialsproject/pymatgen](https://github.com/materialsproject/pymatgen)** – ⭐ 1690 – Python Materials Genomics (pymatgen) is a robust materials analysis code that defines classes for structures and molecules with support for many electronic structure codes. It powers the Materials Project.
...
- **[MultiQC/MultiQC](https://github.com/MultiQC/MultiQC)** – ⭐ 1332 – Aggregate results from bioinformatics analyses across many samples into a single report.
- **[vgteam/vg](https://github.com/vgteam/vg)** – ⭐ 1219 – tools for working with genome variation graphs
- **[thieu1995/mealpy](https://github.com/thieu1995/mealpy)** – ⭐ 1057 – A Collection Of The State-of-the-art Metaheuristic Algorithms In Python (Metaheuristic/Optimizer/Nature-inspired/Biology)
...
- **[igvteam/igv](https://github.com/igvteam/igv)** – ⭐ 688 – Integrative Genomics Viewer. Fast, efficient, scalable visualization tool for genomics data and annotations
...
- **[instadeepai/nucleotide-transformer](https://github.com/instadeepai/nucleotide-transformer)** – ⭐ 668 – Foundation Models for Genomics & Transcriptomics
- **[eggnogdb/eggnog-mapper](https://github.com/eggnogdb/eggnog-mapper)** – ⭐ 637 – Fast genome-wide functional annotation through orthology assignment
...
- **[oschwengers/bakta](https://github.com/oschwengers/bakta)** – ⭐ 539 – Rapid & standardized annotation of bacterial genomes, MAGs & plasmids
...
- **[zeqianli/tgv](https://github.com/zeqianli/tgv)** – ⭐ 380 – Explore genomes in the terminal. Light, blazing fast 🚀, vim-motion.
