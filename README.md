## Trending Bioinformatics Repositories (Updated: 2025-09-20)

**Showing 57 projects matching the criteria (250+ stars, recent updates)**

- **[deepchem/deepchem](https://github.com/deepchem/deepchem)** – ⭐ 6215 – Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry, Materials Science and Biology
- **[ArcInstitute/evo2](https://github.com/ArcInstitute/evo2)** – ⭐ 3080 – Genome modeling and design across all domains of life
- **[satijalab/seurat](https://github.com/satijalab/seurat)** – ⭐ 2518 – R toolkit for single cell genomics
- **[lh3/minimap2](https://github.com/lh3/minimap2)** – ⭐ 2032 – A versatile pairwise aligner for genomic and spliced nucleotide sequences
...
- **[materialsproject/pymatgen](https://github.com/materialsproject/pymatgen)** – ⭐ 1721 – Python Materials Genomics (pymatgen) is a robust materials analysis code that defines classes for structures and molecules with support for many electronic structure codes. It powers the Materials Project.
- **[duerrsimon/bioicons](https://github.com/duerrsimon/bioicons)** – ⭐ 1529 – A library of free open source icons for science illustrations in biology and chemistry
- **[evo-design/evo](https://github.com/evo-design/evo)** – ⭐ 1415 – Biological foundation modeling from molecular to genome scale
...
- **[thieu1995/mealpy](https://github.com/thieu1995/mealpy)** – ⭐ 1082 – A Collection Of The State-of-the-art Metaheuristic Algorithms In Python (Metaheuristic/Optimizer/Nature-inspired/Biology)
- **[sib-swiss/training-collection](https://github.com/sib-swiss/training-collection)** – ⭐ 1059 – Collection of bioinformatics training materials
...
- **[cBioPortal/cbioportal](https://github.com/cBioPortal/cbioportal)** – ⭐ 857 – cBioPortal for Cancer Genomics
- **[biotite-dev/biotite](https://github.com/biotite-dev/biotite)** – ⭐ 857 – A comprehensive library for computational molecular biology
...
- **[marbl/Mash](https://github.com/marbl/Mash)** – ⭐ 418 – Fast genome and metagenome distance estimation using MinHash
- **[evanpeikon/Bioinformatics_Toolkit](https://github.com/evanpeikon/Bioinformatics_Toolkit)** – ⭐ 409 – A growing collection of bioinformatics tutorials, project guides, tools, and articles I’ve developed to make bioinformatics more accessible.
...
- **[labgem/PPanGGOLiN](https://github.com/labgem/PPanGGOLiN)** – ⭐ 279 – Build a partitioned pangenome graph from microbial genomes
