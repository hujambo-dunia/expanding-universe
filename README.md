## Trending Bioinformatics Repositories (Updated: 2025-08-09)

**Showing 59 projects matching the criteria (250+ stars, recent updates)**

- **[deepchem/deepchem](https://github.com/deepchem/deepchem)** – ⭐ 6143 – Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry, Materials Science and Biology
- **[ArcInstitute/evo2](https://github.com/ArcInstitute/evo2)** – ⭐ 3007 – Genome modeling and design across all domains of life
...
- **[MultiQC/MultiQC](https://github.com/MultiQC/MultiQC)** – ⭐ 1339 – Aggregate results from bioinformatics analyses across many samples into a single report.
...
- **[tanghaibao/jcvi](https://github.com/tanghaibao/jcvi)** – ⭐ 842 – Python library to facilitate genome assembly, annotation, and comparative genomics
- **[biotite-dev/biotite](https://github.com/biotite-dev/biotite)** – ⭐ 837 – A comprehensive library for computational molecular biology
- **[cBioPortal/cbioportal](https://github.com/cBioPortal/cbioportal)** – ⭐ 834 – cBioPortal for Cancer Genomics
...
- **[Ensembl/ensembl-vep](https://github.com/Ensembl/ensembl-vep)** – ⭐ 497 – The Ensembl Variant Effect Predictor predicts the functional effects of genomic variants
