## Trending Bioinformatics Repositories (Updated: 2025-09-08)

**Showing 54 projects matching the criteria (250+ stars, recent updates)**

- **[deepchem/deepchem](https://github.com/deepchem/deepchem)** – ⭐ 6189 – Democratizing Deep-Learning for Drug Discovery, Quantum Chemistry, Materials Science and Biology
- **[ArcInstitute/evo2](https://github.com/ArcInstitute/evo2)** – ⭐ 3055 – Genome modeling and design across all domains of life
- **[satijalab/seurat](https://github.com/satijalab/seurat)** – ⭐ 2510 – R toolkit for single cell genomics
...
- **[MultiQC/MultiQC](https://github.com/MultiQC/MultiQC)** – ⭐ 1355 – Aggregate results from bioinformatics analyses across many samples into a single report.
...
- **[scikit-bio/scikit-bio](https://github.com/scikit-bio/scikit-bio)** – ⭐ 968 – scikit-bio: a community-driven Python library for bioinformatics, providing versatile data structures, algorithms and educational resources.
- **[ablab/spades](https://github.com/ablab/spades)** – ⭐ 864 – SPAdes Genome Assembler
...
- **[igvteam/igv](https://github.com/igvteam/igv)** – ⭐ 698 – Integrative Genomics Viewer. Fast, efficient, scalable visualization tool for genomics data and annotations
...
- **[zaeleus/noodles](https://github.com/zaeleus/noodles)** – ⭐ 613 – Bioinformatics I/O libraries in Rust
- **[ComparativeGenomicsToolkit/cactus](https://github.com/ComparativeGenomicsToolkit/cactus)** – ⭐ 603 – Official home of genome aligner based upon notion of Cactus graphs
...
- **[sourmash-bio/sourmash](https://github.com/sourmash-bio/sourmash)** – ⭐ 521 – Quickly search, compare, and analyze genomic and metagenomic data sets.
...
- **[zeqianli/tgv](https://github.com/zeqianli/tgv)** – ⭐ 398 – Explore genomes in the terminal. Light, blazing fast 🚀, vim-motion.
...
- **[evanpeikon/Bioinformatics_Toolkit](https://github.com/evanpeikon/Bioinformatics_Toolkit)** – ⭐ 380 – A growing collection of bioinformatics tutorials, project guides, tools, and articles I’ve developed to make bioinformatics more accessible.
