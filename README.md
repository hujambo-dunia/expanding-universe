...
- **[rust-bio/rust-bio](https://github.com/rust-bio/rust-bio)** – ⭐ 1721 – This library provides implementations of many algorithms and data structures that are useful for bioinformatics. All provided implementations are rigorously tested via continuous integration.
...
- **[sib-swiss/training-collection](https://github.com/sib-swiss/training-collection)** – ⭐ 1041 – Collection of bioinformatics training materials
...
- **[bernatgel/karyoploteR](https://github.com/bernatgel/karyoploteR)** – ⭐ 331 – karyoploteR - An R/Bioconductor package to plot arbitrary data along the genome
...
- **[CompEpigen/figeno](https://github.com/CompEpigen/figeno)** – ⭐ 297 – Tool for plotting sequencing data along genomic coordinates.
